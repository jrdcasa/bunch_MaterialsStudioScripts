...
my $steps = 21;
my $delta = 0.1;
my $initialxsd = "Try02.xsd";
my $iatom1 = 0;  # in the fix fragment
my $iatom2 = 57;  # in the mobile fragment
my $nameSets = "Set2";
...
for (my $istep=0; $istep<$steps; ++$istep) {
	...
	# the final structure is chosen and the fragments are move by delta angstroms.
	if ($istep == 0) {
